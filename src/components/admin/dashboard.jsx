  ...
  <div className="content-wrapper-scroll">
      ...
      <div className="content-wrapper">
        ...
        <div className="row gx-3">
          ...
          <div className="col-lg-3 col-sm-6 col-12">
            <div className="stats-tile d-flex align-items-center position-relative tile-yellow">
              <div className="sale-icon icon-box xl rounded-5 me-3">
                <i className="bi bi-emoji-smile font-2x text-yellow"></i>
              </div>
              <div className="sale-details text-white">
                <h6>Total Users</h6>
                <h2 className="m-0">725</h2>
              </div>
            </div>
          </div>
