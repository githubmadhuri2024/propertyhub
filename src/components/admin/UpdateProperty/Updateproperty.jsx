...
const UpdateProperty=()=>{
 ...
 const {
  ...
  const fetchProperty=async()=>{
      ...
      try{
        const response=await axios.get(`http://localhost:5000/api/property/getProperty/${id}`);
...
const removeImage=(index)=>{
  ...
  setImagePreviews(updatedPreviews);
   ...
   const onSubmit=async(data)=>{
     ...
     try{
       ...
       const response = await axios.post(`http://localhost:5000/api/property/updateProperty/${id}`,
          formData,
          {
        headers: {
    ...
    reset({
      ...
      ownerId: response.data.property.ownerId,
 ...
 <small className="text-muted">
                          ...
                          {imagePreviews.length > 0 && (
                            ...
                            <select className="form-control"   id="ownerId"  name="ownerId" {...register("ownerId")} >
